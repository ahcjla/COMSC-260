...
.data
    ...
    titleMsg            byte "Program 6 by Fred Kennedy",0

    testingShifterMsg   byte "Testing Shifter",0
    testingDspBinMsg    byte "Testing DspBin",0

    enabledMsg          byte "(Shifting enabled C = 1, Disabled C = 0)",0

    header       byte  "A B C | Output",0
